...
const selectStockItem = state => 
  state.stock.item;

const stockSelector = state =>
  state.stock.stock;

const itemCodeSelector = state =>
  state.stock.itemCode;

const stockErrorsSelector = state =>
  state.stock.error;

const stockLoadingSelector = state =>
  state.stock.loading;
